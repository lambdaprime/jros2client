 ...
 */
public record SubscriberQos(QosReliability qosReliability, QosDurability qosDurability) {
    ...
    public SubscriberQos(QosReliability qosReliability) {
        this(qosReliability, DEFAULT_SUBSCRIBER_QOS_DURABILITY);
    }

    public SubscriberQos(QosDurability qosDurability) {
        this(DEFAULT_SUBSCRIBER_QOS_RELIABILITY, qosDurability);
    }
